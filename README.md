# VulkanTesting
This is a repostitory mostly intended for private use and reference by me when writing Vulkan code. As of the time of writing the project can use either SDL or GLFW to render a triangle using Vulkan's C++ RAII implementation.
